...
const skills=['HTML','CSS','Tailwind','JavaScript','React','NextJs','Redux','PostgreeSql','GitHub']
    ...
    return (
        ...
        >
            ...
            <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
                {/* TEXT CONTAINER */}
                <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-12 flex flex-col gap-24 md:gap-28 lg:gap-32 xl:gap-40 lg:w-2/3 lg:pr-0 xl:w-1/2">
                    {/* BIOGRAPHY CONTAINER */}
                    <div className="flex flex-col gap-12 justify-center">
                        {/* BIOGRAPHY IMAGE */}
                        <Image
                            src="/satyarthpic.jpeg"
                            alt=""
                            width={112}
                            height={112}
